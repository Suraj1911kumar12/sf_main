...
const MessageDetailsModalForGroup = ({ onClose, onClick, contextMenu }) => {
    ...
    >
      <ul className="flex flex-col divide-y divide-gray-200">
        {menuOptions.map((option) => (
          ...
          >
            {option.icon}
            <span className="text-sm text-black">{option.title}</span>
          </li>
        ))}
      </ul>
    </div>
...
export default MessageDetailsModalForGroup;
